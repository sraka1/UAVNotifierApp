...
export const MainToggle: Main = {
  ...
  data: [
    ...
    >
      ...
      <MainDivider size={24} style={{ width: "100%" }} />
    ...
    >
      ...
      <ControlledToggle
        variant="radio"
        value
        labelTx="mainShowroomScreen.demoViaSpecifiedTxProp"
        labelTxOptions={{ prop: "label" }}
        helperTx="mainShowroomScreen.demoViaSpecifiedTxProp"
    ...
    <MainUseCase name="Styling" description="The component can be styled easily." layout="row">
      <ControlledToggle
        variant="checkbox"
        containerStyle={$centeredOneThirdCol}
        inputOuterStyle={{
      ...
      <MainDivider size={32} style={{ width: "100%" }} />
