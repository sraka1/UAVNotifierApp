...
export const MainListItem: Main = {
  name: "ListItem",
  description: "A styled row component that can be used in FlatList, SectionList, or by itself.",
  data: [
    <MainUseCase name="Height" description="The row can be different heights.">
    ...
    <MainUseCase name="Icons" description="You can customize the icons on the left or right.">
    ...
    >
      ...
      <ListItem topSeparator tx="mainShowroomScreen.demoViaTxProp" />
