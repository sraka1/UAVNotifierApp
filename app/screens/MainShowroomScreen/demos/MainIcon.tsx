...
export const MainIcon: Main = {
  ...
  data: [
    ...
    <MainUseCase name="Size" description="There's a size prop." layout="row">
    ...
    <MainUseCase name="Color" description="There's a color prop." layout="row">
