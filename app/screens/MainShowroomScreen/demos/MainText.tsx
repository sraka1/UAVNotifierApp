...
export const MainText: Main = {
  ...
  data: [
    ...
    <MainUseCase name="Sizes" description="There's a size prop.">
    ...
    <MainUseCase name="Weights" description="There's a weight prop.">
      <Text weight="light">
    ...
    >
      ...
      <Text>
        ...
        <Text tx="mainShowroomScreen.lorem2Sentences" />
      </Text>
