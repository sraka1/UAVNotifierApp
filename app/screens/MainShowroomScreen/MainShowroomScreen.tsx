...
const WebListItem: FC<MainListItem> = ({ item, sectionIndex }) => {
...
const NativeListItem: FC<MainListItem> = ({ item, sectionIndex, handleScroll }) => {
  return (
    <View>
...
export const MainShowroomScreen: FC<MainTabScreenProps<"MainShowroom">> =
  function MainShowroomScreen(_props) {
    ...
    const route = useRoute<RouteProp<MainTabParamList, "MainShowroom">>()
    const params = route.params

    // handle Web links
    React.useEffect(() => {
      if (route.params) {
        const demoValues = Object.values(Mains)
        ...
        renderNavigationView={() => (
          <View style={[$drawer, $drawerInsets]}>
            ...
            <FlatList<{ name: string; useCases: string[] }>
              ...
              data={Object.values(Mains).map((d) => ({
                name: d.name,
      ...
      >
        <Screen preset="fixed" safeAreaEdges={["top"]} contentContainerStyle={$screenContainer}>
          ...
          <SectionList
            ...
            sections={Object.values(Mains)}
            renderItem={({ item }) => item}
            renderSectionFooter={() => <View style={$demoUseCasesSpacer} />}
            ListHeaderComponent={
              <View style={$heading}>
                <Text preset="heading" tx="mainShowroomScreen.jumpStart" />
              </View>
            }
